...
export default class Animation {
    ...
    _animate(element, duration, properties, value, delay) {
        function to(element, duration, properties, value, lerp = this.lerp) {
        ...
        element.style[properties.base] = properties.property ? `${properties.property}(${this.startValue}${properties.base == 'transform' ? '%' : ''})` : this.startValue
        setTimeout(() => {
            let pp = new to(element, duration, properties, value, this.lerp)
            console.log(pp);
        }, delay)
    }
